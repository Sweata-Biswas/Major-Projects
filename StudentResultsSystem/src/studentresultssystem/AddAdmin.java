...
public class AddAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 220, 170, 30));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 170, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 430, -1, 40));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studentresultssystem/schoolPic1.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM admindata WHERE username ='"+username+"'");
            if(rs.first()){
                JOptionPane.showMessageDialog(null, "Username already exist ");
            }else{
            st.executeUpdate("INSERT INTO  admindata (username,password) VALUES('"+username+"','"+password+"')");
