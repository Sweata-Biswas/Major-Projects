...
public class AdminLoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, 160, -1));
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, 160, -1));

        jButton1.setFont(new java.awt.Font("HP Simplified", 1, 14)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studentresultssystem/icons8-submit-document-32.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studentresultssystem/icons8-cancel-24.png"))); // NOI18N
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, -1, 40));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studentresultssystem/schoolPic2.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM admindata WHERE username ='"+username+"' AND password ='"+password+"'");
            if(!rs.first()){
                JOptionPane.showMessageDialog(null, "Wrong credential. kindly check with the User Name or Password");
            }
            else{
                setVisible(false);
